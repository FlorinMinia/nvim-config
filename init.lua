...
require('lazy').setup({
  ...
  -- Fuzzy finder for files, LSP symbols, grep, and more
  {
  ...
  -- LSP configuration with automatic server installation via Mason
  {
    ...
    config = function()
      ...
      -- Language servers (add more as needed, see :help lspconfig-all)
      local servers = {
        gopls = {},
        pyright = {},
        lua_ls = {
      ...
      vim.list_extend(ensure_installed, { 'stylua', 'ruff', 'golangci-lint' })
  ...
  -- Mini.nvim collection: ai textobjects, surround, statusline
  {
    'echasnovski/mini.nvim',
    config = function()
      require('mini.ai').setup { n_lines = 500 }      -- Better around/inside textobjects (va), ci', etc)
  ...
  -- Syntax highlighting and code navigation via Treesitter
  {
  ...
  -- Treesitter textobjects for code-aware selections (vif = select inner function, etc)
  {
  ...
  -- Flash.nvim for faster navigation (press 's' to jump anywhere)
  {
    'folke/flash.nvim',
    event = 'VeryLazy',
    opts = {},
  ...
  -- Additional plugins from kickstart modules
